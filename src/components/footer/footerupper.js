    ...
    return (
        <div className="grid md:grid-cols-2 grid-cols-1 gap-3 bg-jade text-white">
            <div className="bg-bottleGreen flex md:justify-end justify-center">
                <div className='flex justify-around md:w-[80%] w-[90%] pt-5 md:mb-0 mb-5'>
                {
                    links.map(item=>(
                        <div key={item}>
                            <div className={roadRage.className}>
                            <h1  className='lg:text-5xl md:text-3xl text-3xl underline decoration-[#00A3FF]'>{item.title}</h1>
                            </div>
                            <div className={roboto.className}>
                                {
                                    ...
                                    (
                                        <h3 key={data.id} className='font-bold text-[10px]  md:text-[10px] lg:text-[12px] xl:text-[14px]'>{data.lname}</h3>
                                    ))
                                }
                            </div>
                        </div>
            ...
            <div className="bg-bottleGreen pt-3 flex flex-col gap-10 ">
                ...
                <div className='flex  lg:w-[70%] xl:w-[50%] w-[90%] mx-auto mb-3 '>
